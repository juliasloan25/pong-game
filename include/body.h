 ...
 *   e.g. its type if the scene has multiple types of bodies
 * @param info_freer if non-NULL, a function call on the info to free it
 * @param coll_limit the number of collisions before the body is destroyed
 * @return a pointer to the newly allocated body
 */
...
/**
 * Adds to the counter of collisions.
 * This function will set the body as removed if reaches collision limit.
 *
 * @param body the body to check
 */
